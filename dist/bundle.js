...
module.exports = __webpack_require__(/*! /Users/utkarshdwivedi/Documents/phaserProjects/blob/src/main.js */330);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(/*! ./_hide */ 11)(proto, TO_PRIMITIVE, __webpack_require__(/*! ./_date-to-primitive */ 212));
...
var _phaserCe = __webpack_require__(/*! phaser-ce */ 46);
...
var _Splash = __webpack_require__(/*! ./states/Splash */ 334);
...
var Game = function (_Phaser$Game) {
  ...
  function Game() {
    ...
    var gameConfig = {
      ...
      renderer: _phaserCe2.default.CANVAS,
      parent: "game-cont",
      state: null
    };
...
var BootState = function (_Phaser$State) {
  ...
  _createClass(BootState, [{
    ...
    value: function create() {
      ...
      this.scale.scaleMode = _phaserCe2.default.ScaleManager.SHOW_ALL;

      this.physics.startSystem(_phaserCe2.default.Physics.ARCADE);
...
var _assetData = __webpack_require__(/*! ../asset-data */ 335);

var _assetData2 = _interopRequireDefault(_assetData);

var _retinaAssetsProcess = __webpack_require__(/*! ../retina-assets-process */ 337);

var _retinaAssetsProcess2 = _interopRequireDefault(_retinaAssetsProcess);
...
var SplashState = function (_Phaser$State) {
  ...
  function SplashState(game) {
    ...
    return _possibleConstructorReturn(this, (SplashState.__proto__ || Object.getPrototypeOf(SplashState)).call(this, game));
  }
  ...
  _createClass(SplashState, [{
    ...
    value: function preload() {
      ...
      this.preloadBar.position.setTo(this.world.centerX - this.preloadBar.width / 2, this.world.centerY);
      this.preloadBar.width = 0;

      addProgressOuter(this.game, this.preloadBar.position.x, this.preloadBar.position.y - 16);

      this.load.pack("gameAssets", undefined, _assetData2.default);
    }
  }, {
    key: "create",
    value: function create() {
      ...
      (0, _retinaAssetsProcess2.default)(this.game, function () {
    ...
    value: function loadUpdate() {
      ...
      var width = this.preloadBar.texture.width / 100 * this.load.progress;
      this.preloadTween = this.add.tween(this.preloadBar).to({ width: width }, 200, "Linear");
      this.preloadTween.onComplete.addOnce(function () {
        return _this3.preloadTween = null;
      });
...
var _assetPack = __webpack_require__(/*! ./asset-pack */ 336);

var _assetPack2 = _interopRequireDefault(_assetPack);
...
var assetsPath = _config2.default.scale == 2 ? "assets_retina" : "assets";

_assetPack2.default.forEach(function (asset) {
  asset.url = assetsPath + "/" + asset.url;
});

exports.default = {
  gameAssets: _assetPack2.default
};
...
exports.default = function (game, callback) {

  if (_config2.default.scale < 2) return callback && callback();
...
function processImages(game, keys, callback) {
  ...
  var key = keys.shift();
  var sprite = new _phaserCe2.default.Sprite(game, 0, 0, key);

  var bmpAsset = new _phaserCe2.default.BitmapData(game, key + "-bitmap", sprite.width, sprite.height);

  bmpAsset.draw(sprite, 0, 0, sprite.width / 2, sprite.height / 2);

  bmpAsset.generateTexture(key, function () {
    bmpAsset.destroy();
...
var GameState = function (_Phaser$State) {
  ...
  function GameState(game) {
    ...
    return _possibleConstructorReturn(this, (GameState.__proto__ || Object.getPrototypeOf(GameState)).call(this, game));
  }
  ...
  _createClass(GameState, [{
    ...
    key: 'create',
    value: function create() {
      game.physics.startSystem(_phaserCe2.default.Physics.P2JS);
    ...
    value: function update() {
      ...
      this.blob.forEach(function (element) {
        if (element.name == "side" && last) {
          if (!last) {
            last = element;
            first = element;
          } else if (last.name != "center") {
            _this2.graphics.lineStyle(2, 0x33FF00);
            _this2.graphics.moveTo(last.x, last.y);
            _this2.graphics.lineTo(element.x, element.y);
          }
        }
        last = element;
      });
    ...
    value: function createBlob() {
      ...
      var lastBall = false;
      var firstBall = false;
      for (var index = 0; index < this.noBalls; index++) {
        var newBall = game.add.sprite(this.centerX + this.r * Math.cos(index * 2 * Math.PI / this.noBalls), this.centerY + this.r * Math.sin(index * 2 * Math.PI / this.noBalls), 'ball');
